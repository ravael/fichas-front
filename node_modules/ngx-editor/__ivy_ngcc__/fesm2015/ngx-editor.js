import { EventEmitter, Component, forwardRef, ViewEncapsulation, Renderer2, ViewChild, Input, Output, ɵɵdefineInjectable, Injectable, ɵɵinject, Optional, HostBinding, ElementRef, HostListener, Pipe, NgModule, InjectionToken } from '@angular/core';
...
const _c1 = function (a0) { return { "NgxEditor--Disabled": a0 }; };
...
const _c2 = function (a0, a1) { return { "NgxEditor__Dropdown--Active": a0, "NgxEditor--Disabled": a1 }; };
function DropdownComponent_div_2_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(2, _c2, item_r2 === ctx_r1.activeItem, ctx_r1.disabledItems.includes(item_r2)));
    ɵngcc0.ɵɵadvance(1);
...
const _c4 = function (a0) { return { "NgxEditor__Color--Active": a0 }; };
function ColorPickerComponent_div_2_div_1_button_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(3, _c3, color_r4, ctx_r3.getContrastYIQ(color_r4)))("title", color_r4)("ngClass", ɵngcc0.ɵɵpureFunction1(6, _c4, ctx_r3.activeColors.includes(color_r4)));
} }
...
import { toggleMark, lift, wrapIn, setBlockType, newlineInCode, createParagraphNear, liftEmptyBlock, splitBlock, chainCommands, baseKeymap } from 'prosemirror-commands';
...
import { editable, placeholder } from 'ngx-editor/plugins';
...
NgxEditorComponent.ɵfac = function NgxEditorComponent_Factory(t) { return new (t || NgxEditorComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxEditorComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.Renderer2 }]; }, { placeholder: [{
            type: Input
        }], enabled: [{
            type: Input
        }], focusOut: [{
...
MenuComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MenuComponent, selectors: [["ngx-editor-menu"]], inputs: { toolbar: "toolbar", colorPresets: "colorPresets", disabled: "disabled", customMenuRef: "customMenuRef", editor: "editor" }, decls: 3, vars: 5, consts: [[1, "NgxEditor__MenuBar", 3, "ngClass"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "toolbarItem", "class", 4, "ngIf"], [3, "class", 4, "ngIf"], ["type", "text_color", 3, "class", "presets", 4, "ngIf"], ["type", "background_color", 3, "class", "presets", 4, "ngIf"], [3, "toolbarItem"], [3, "class", "group", "items", 4, "ngFor", "ngForOf"], [3, "group", "items"], ["type", "text_color", 3, "presets"], ["type", "background_color", 3, "presets"], [3, "ngTemplateOutlet"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
...
ToggleCommandComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ToggleCommandComponent, selectors: [["ngx-toggle-command"]], hostVars: 4, hostBindings: function ToggleCommandComponent_HostBindings(rf, ctx) { if (rf & 2) {
    ...
    } }, pipes: function () { return [SanitizeHtmlPipe]; }, styles: [""] });
...
LinkComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: LinkComponent, selectors: [["ngx-link"]], hostVars: 4, hostBindings: function LinkComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc1.NgIf, ɵngcc2.ɵangular_packages_forms_forms_y, ɵngcc2.NgControlStatusGroup, ɵngcc2.FormGroupDirective, ɵngcc2.DefaultValueAccessor, ɵngcc2.NgControlStatus, ɵngcc2.FormControlName, ɵngcc2.CheckboxControlValueAccessor]; }, pipes: function () { return [SanitizeHtmlPipe]; }, styles: [""] });
...
ImageComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ImageComponent, selectors: [["ngx-image"]], hostVars: 2, hostBindings: function ImageComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngIf", ctx.showPopup);
    } }, directives: function () { return [ɵngcc1.NgIf, ɵngcc2.ɵangular_packages_forms_forms_y, ɵngcc2.NgControlStatusGroup, ɵngcc2.FormGroupDirective, ɵngcc2.DefaultValueAccessor, ɵngcc2.NgControlStatus, ɵngcc2.FormControlName]; }, pipes: function () { return [SanitizeHtmlPipe]; }, styles: [""] });
...
SanitizeHtmlPipe.ɵfac = function SanitizeHtmlPipe_Factory(t) { return new (t || SanitizeHtmlPipe)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.DomSanitizer)); };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MenuModule, { declarations: function () { return [SanitizeHtmlPipe, MenuComponent, ToggleCommandComponent, LinkComponent, DropdownComponent, ImageComponent, ColorPickerComponent]; }, imports: function () { return [CommonModule,
        ReactiveFormsModule]; }, exports: function () { return [MenuComponent]; } }); })();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(BubbleComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }]; }, { editor: [{
            type: Input
        }] }); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxEditorModule, { declarations: function () { return [NgxEditorComponent, BubbleComponent]; }, imports: function () { return [CommonModule, MenuModule]; }, exports: function () { return [NgxEditorComponent, MenuComponent]; } }); })();
...
class Editor {
    ...
    createEditor() {
        ...
        const editable$1 = enabled !== null && enabled !== void 0 ? enabled : true;
        const placeholder$1 = (_a = options.placeholder) !== null && _a !== void 0 ? _a : '';
...
export { Editor, MenuComponent, NgxEditorComponent, NgxEditorModule, Validators, emptyDoc, parseContent, toDoc, toHTML, ɵ0, ɵ1, ɵ2, MenuService as ɵa, MenuModule as ɵb, SanitizeHtmlPipe as ɵc, ToggleCommandComponent as ɵd, NgxEditorServiceConfig as ɵe, NgxEditorService as ɵf, provideMyServiceOptions as ɵg, LinkComponent as ɵh, DropdownComponent as ɵi, ImageComponent as ɵj, ColorPickerComponent as ɵk, BubbleComponent as ɵl };
