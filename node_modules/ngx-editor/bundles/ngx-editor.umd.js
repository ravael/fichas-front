(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-editor'] = {}, global.ng.core, global.ng.forms, global.prosemirrorModel, global['ngx-editor'].schema, global.rxjs, global.ng.common, global.prosemirrorCommands, global['ngx-editor'].commands, global['ngx-editor'].helpers, global.prosemirroSchemaList, global.prosemirrorState, global.ng.platformBrowser, global.prosemirrorView, global['ngx-editor'].plugins, global['ngx-editor'].utils, global.prosemirrorKeymap, global.prosemirrorHistory, global.prosemirrorInputRules));
}(this, (function (exports, i0, forms, prosemirrorModel, schema, rxjs, common, prosemirrorCommands, commands, helpers, prosemirrorSchemaList, prosemirrorState, platformBrowser, prosemirrorView, plugins, utils, prosemirrorKeymap, prosemirrorHistory, prosemirrorInputrules) { 'use strict';
    ...
    var NgxEditorComponent = /** @class */ (function () {
        function NgxEditorComponent(renderer) {
        ...
        NgxEditorComponent.prototype.ngOnInit = function () {
            ...
            var contentChangeSubscription = this.editor.onContentChange.subscribe(function (jsonDoc) {
                _this.handleChange(jsonDoc);
            });
            var blurSubscription = this.editor.onBlur.subscribe(function () {
                _this.focusOut.emit();
                _this.onTouched();
            });
            var focusScbscription = this.editor.onFocus.subscribe(function () {
                _this.focusIn.emit();
            });
    ...
    ***************************************************************************** */
    ...
    var MenuService = /** @class */ (function () {
        ...
        Object.defineProperty(MenuService.prototype, "view", {
            get: function () {
    ...
    var MenuComponent = /** @class */ (function () {
        ...
        MenuComponent.prototype.ngOnInit = function () {
            ...
            this.updateSubscription = this.editor.onUpdate.subscribe(function () {
                _this.menuService.plugin.update.next(_this.editor.view);
            });
        };
    ...
    var ToggleCommandComponent = /** @class */ (function () {
        function ToggleCommandComponent(ngxeService, menuService) {
            ...
            this.pluginUpdateSubscription = this.menuService.plugin.update.subscribe(function (view) {
                _this.update(view);
            });
        }
    ...
    var BubbleComponent = /** @class */ (function () {
        function BubbleComponent(el, renderer) {
            this.el = el;
            this.renderer = renderer;
        }
        BubbleComponent.prototype.setDomPosition = function () {
            // Otherwise, reposition it and update its content
            this.showBubble();
            var _a = helpers.calculateBubblePos(this.view, this.el.nativeElement), bottom = _a.bottom, left = _a.left;
    ...
    var Editor = /** @class */ (function () {
        function Editor(options) {
            ...
            this.onContentChange = new rxjs.Subject();
        ...
        Editor.prototype.createEditor = function () {
            ...
            var _c = options.content, content = _c === void 0 ? null : _c, nodeViews = options.nodeViews, enabled = options.enabled;
            var _d = options.history, history = _d === void 0 ? true : _d, _e = options.keyboardShortcuts, keyboardShortcuts = _e === void 0 ? true : _e, _f = options.inputRules, inputRules = _f === void 0 ? true : _f;
            var schema = this.schema;
            var editable = enabled !== null && enabled !== void 0 ? enabled : true;
            var placeholder = (_a = options.placeholder) !== null && _a !== void 0 ? _a : '';
            var doc = parseContent(content, schema);
            this.el = document.createDocumentFragment();
            var plugins$1 = __spread([
                plugins.editable(),
            ...
            plugins$1.push.apply(plugins$1, __spread(defaultPlugins));
            this.view = new prosemirrorView.EditorView(this.el, {
        ...
        Editor.prototype.enable = function () {
            var _c = this.view, dispatch = _c.dispatch, tr = _c.state.tr;
    ...
    exports.ɵb = MenuModule;
    exports.ɵc = SanitizeHtmlPipe;
